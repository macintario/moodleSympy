...
public class Constantes {
    ...
    public static String XML_SUFIJO = "]]></text>\n"
            ...
            + "      <text>"
            + "Instrucciones para hacer autoevaluaciones y poder presentar examen de unidad."
+"$$ a_2).$$ Nos interesa que tú domines el ejercicio aquí mostrado; para ello tendrás que seguir el procedimiento detallado que ofrece Symbolab. (Cualquier duda con Symbolab, consulta a cualquier profesor de galoisenlinea, para ello acude a Sala SAV-01 en horarios de clase.)"
+       "$$ a_3).$$ Realiza tantas autoevaluaciones como tú lo necesites."
+"SOLUCIÓN:"
+"PROCEDIMIENTO DE SOLUCION PASO A PASO"
+"En este ejercicio y con objeto de que uses uno de los mejores Sistemas Algebraicos Computacionales (CAS) llamado Symbolab, obtendrás el procedimiento de solución de este ejercicio paso a paso."
