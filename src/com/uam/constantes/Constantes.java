...
public class Constantes {
    ...
    public static String XML_SUFIJO = "]]></text>\n"
            ...
            +"(Cualquier duda con Symbolab, consulta a cualquier profesor de galoisenlinea, para ello acude a Sala SAV-01 en horarios de clase.)"
            +"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$$ a_3).$$ Realiza tantas autoevaluaciones como tú lo necesites."
            +"<br/><br/><span style=\"color: #000000; font-size: x-large\"><strong>SOLUCIÓN:</strong></span>"
