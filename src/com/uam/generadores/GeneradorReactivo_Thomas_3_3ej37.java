...
public class GeneradorReactivo_Thomas_3_3ej37 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x37_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej37.xml";
    ...
    private static final String EXPRESION = "(\\frac{$CONSTANTEA$+$CONSTANTEB$x}{$CONSTANTEC$x})($CONSTANTED$-x)";
    private String RESPUESTA= "$$\\displaystyle y'(x)=\\frac{Ax^2+B}{Cx^D}$$ <br/><br/>" +
            "$$\\displaystyle y''(x)=\\frac{E}{Fx^G}$$ <br/>";
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_37_";
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer respuestaB = -constanteA*constanteD;
        Integer respuestaC = constanteC;
        Integer respuestaD = 2;
        Integer respuestaE = 2*constanteA*constanteD;
        ...
        Integer divisor = maximoComunDivisor(respuestaF, respuestaG);
        divisor = maximoComunDivisor(divisor, respuestaH);
        respuestaE *= divisor;
        respuestaF /= divisor;
        respuestaG /= divisor;
        respuestaH /= divisor;
...
//
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej37());
    }
