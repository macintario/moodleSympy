...
public class GeneradorReactivo_Thomas_3_3ej20 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x20_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej20.xml";
    ...
    private static final String EXPRESION = "\\frac{$CONSTANTEA$x^2-$CONSTANTEB$}{x^2+$CONSTANTEC$x-$CONSTANTED$}";
    private String RESPUESTA= "$$\\displaystyle y'(x)=\\frac{Ax^2+Bx+C}{(x^2+Dx+E)^F}$$ <br/>";
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_20_";
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer respuestaB = 2*(constanteB-constanteA*constanteD);
        Integer respuestaC = constanteB*constanteC;
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej20());
    }
