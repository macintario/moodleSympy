...
public class GeneradorReactivo_Thomas_3_6ej42 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_6x42_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_6ej42.xml";
    ...
    private static final String EXPRESION = "\\sec^$CONSTANTEA$(\\pi x -$CONSTANTEB$)";
    private String RESPUESTA= "$$\\displaystyle\\frac{df}{dx}=\\frac{A\\pi\\sin(\\pi x-B)}{ \\cos^{C}(\\pi x - D)}$$ <br/>";
 ...
 */
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.6_Ej_42_";
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer respuestaC = constanteA+1;
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_6ej42());
    }
