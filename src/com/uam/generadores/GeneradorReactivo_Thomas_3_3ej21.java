...
public class GeneradorReactivo_Thomas_3_3ej21 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x21_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej21.xml";
    ...
    private static final String EXPRESION = "($CONSTANTEA$-x)($CONSTANTEB$+$CONSTANTEC$x^2)^{-1}";
    private String RESPUESTA= "$$\\displaystyle y'(x)=\\frac{Ax^2+Bx+C}{(Dx^2+E)^F}$$ <br/>";
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_21_";
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej21());
    }
