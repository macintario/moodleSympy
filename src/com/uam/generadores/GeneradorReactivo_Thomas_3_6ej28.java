...
public class GeneradorReactivo_Thomas_3_6ej28 implements GeneradorReactivoCloze {
     ...
     * "<!--Reactivo Thomas_3_6x28_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_6ej28.xml";
    ...
    private static final String EXPRESION = "($CONSTANTEA$-$CONSTANTEB$x)^{-$CONSTANTEC$} + \\frac{1}{$CONSTANTED$} (\\frac{$CONSTANTEE$}{x}+1)^{$CONSTANTEG$}";
    private String UX = "(\\frac{$CONSTANTEE$}{x}+1)";
    private String VX = "($CONSTANTEA$-$CONSTANTEB$x)";
    ...
    private String CAJAS_RESPUESTA = "$$A=$${1:SHORTANSWER:=$RESPUESTA_A$} <br/> $$B=$${1:SHORTANSWER:=$RESPUESTA_B$} <br/> "
            ...
            + "<script type=\"math/tex\">\\bullet</script> &nbsp;&nbsp;&nbsp; Los números $$A,B,C,D,E,F,G,H,J,K$$ en este orden y que dan solución correcta al ejercicio son: </strong></span>"
            + " &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
            +" {20:SHORTANSWER:=$RESPUESTA_A$,$RESPUESTA_B$,$RESPUESTA_C$,$RESPUESTA_D$,$RESPUESTA_E$,$RESPUESTA_F$,$RESPUESTA_G$,$RESPUESTA_H$,"
            + "$RESPUESTA_J$,$RESPUESTA_K$}</center> <br>"
            + "</center>";
/**
 *
 */
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.6_Ej_28_";
...
//        Integer constanteG = Utilidades.obtenerImparAleatorioDistintoDe(COTA_CONSTANTE_G[0], COTA_CONSTANTE_G[1], constanteD);
        ...
        solucion = solucionaSimbolico.sumaPotenciasCadena(a, ux, n, vx, m);
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_6ej28());
    }
