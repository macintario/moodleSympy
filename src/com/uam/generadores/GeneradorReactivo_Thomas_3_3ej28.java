...
public class GeneradorReactivo_Thomas_3_3ej28 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x28_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej28.xml";
    ...
    private static final String EXPRESION = "\\frac{(x+$CONSTANTEA$)(x+$CONSTANTEB$)}{(x-$CONSTANTEA$)(x-$CONSTANTEB$)}";
    private String RESPUESTA= "$$\\displaystyle y'(x)=\\frac{A(x^2+B)}{(x-$CONSTANTEA$)^C(x-$CONSTANTEB$)^D}$$ <br/>";
    private String CAJAS_RESPUESTA = "$$A=$${1:SHORTANSWER:=$RESPUESTA_A$} <br/> $$B=$${1:SHORTANSWER:=$RESPUESTA_B$} <br/> "
            ...
            + "<script type=\"math/tex\">\\bullet</script> &nbsp;&nbsp;&nbsp; Los números " +
            "$$A,B,C,D$$ en este orden "
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_28_";
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej28());
    }
