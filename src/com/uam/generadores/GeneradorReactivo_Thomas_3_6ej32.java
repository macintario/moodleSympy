...
public class GeneradorReactivo_Thomas_3_6ej32 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_6x32_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_6ej32.xml";
    ...
    private static final String EXPRESION = "x^{$CONSTANTEA$} \\sec({\\frac{$CONSTANTEB$}{x}})+$CONSTANTEC$";
 ...
 */
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.6_Ej_32_";
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_6ej32());
    }
