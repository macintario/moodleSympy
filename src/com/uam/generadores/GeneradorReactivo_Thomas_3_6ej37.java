...
public class GeneradorReactivo_Thomas_3_6ej37 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_6x37_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_6ej37.xml";
    ...
    private static final String EXPRESION = "(\\sin(x^$CONSTANTEA$)\\cos($CONSTANTEB$x))";
    private String RESPUESTA= "$$\\displaystyle\\frac{df}{dx}=Ax^{B}\\cos(Cx)\\cos(x^{D})+E\\sin(Fx)\\sin(x^{G})$$ <br/>";
 ...
 */
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.6_Ej_37_";
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_6ej37());
    }
