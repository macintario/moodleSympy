...
public class GeneradorReactivo_Thomas_3_6ej27 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_6x27_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_6ej27.xml";
    ...
    private String RESPUESTA= "$$\\displaystyle\\frac{df}{dx}=A(Bx-C)^D+\\frac{Ex^{F}}{(Gx^{H}+J)^{K}}$$ <br/>";
 ...
 */
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer constanteG = Utilidades.obtenerImparAleatorioDistintoDe(COTA_CONSTANTE_G[0], COTA_CONSTANTE_G[1], constanteA);
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_6ej27());
    }
