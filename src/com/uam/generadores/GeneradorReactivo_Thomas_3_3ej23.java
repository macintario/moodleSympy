...
public class GeneradorReactivo_Thomas_3_3ej23 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x23_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej23.xml";
    ...
    private static final String EXPRESION = "\\frac{\\sqrt{x}-$CONSTANTEA$}{\\sqrt{x}+$CONSTANTEB$}";
    private String RESPUESTA= "$$\\displaystyle y'(x)=\\frac{A}{2\\sqrt{x}(x^{\\frac{1}{B}}+C)^D}$$ <br/>";
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_23_";
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer constanteA = Utilidades.obtenerParAleatorio(COTA_CONSTANTE_A[0], COTA_CONSTANTE_A[1]);
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej23());
    }
