...
public class GeneradorReactivo_Thomas_3_6ej39 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_6x39_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_6ej39.xml";
    ...
    private static final String EXPRESION = "\\sin(\\frac{$CONSTANTEA$x}{\\sqrt{x+$CONSTANTEB$}})";
    private String RESPUESTA= "$$\\displaystyle\\frac{df}{dx}=\\frac{A(x+B)\\cos(\\frac{Cx}{\\sqrt{x+D}})}{E(x+F)^{\\frac{G}{H}}}$$ <br/>";
 ...
 */
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.6_Ej_39_";
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_6ej39());
    }
