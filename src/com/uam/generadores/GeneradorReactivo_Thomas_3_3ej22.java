...
public class GeneradorReactivo_Thomas_3_3ej22 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x22_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej22.xml";
    ...
    private static final String EXPRESION = "($CONSTANTEA$x-$CONSTANTEB$)^{-1}(x+$CONSTANTEC$)";
    private String RESPUESTA= "$$\\displaystyle y'(x)=A(Bx+C)^D$$ <br/>";
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_22_";
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer respuestaA = -constanteB-constanteA*constanteC;
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej22());
    }
