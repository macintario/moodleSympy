...
public class GeneradorReactivo_Thomas_3_3ej38 implements GeneradorReactivoCloze {
    /**
     ...
     * "<!--Reactivo Thomas_3_3x38_000-->"
     */
    private static final int POSICIONES_CONTADOR_REACTIVO = 3;
    /**
     * El nombre o ruta absoluta del archivo de salida.
     */
    private static final String NOMBRE_ARCHIVO_SALIDA = "reactivos_Thomas_3_3ej38.xml";
    ...
    private static final String EXPRESION = "(x+$CONSTANTEA$)(x-$CONSTANTEB$)(x^2-$CONSTANTEC$)";
    private String RESPUESTA= "$$\\displaystyle y'(x)=Ax^3+Bx^2+Cx+D$$ <br/><br/>" +
            "$$\\displaystyle y''(x)=Ex^2+Fx+G$$ <br/>";
     ...
     *
     */
    private static final String COMENTARIO_REACTIVO_PREFIJO = "Reactivo Thomas_3.3_Ej_38_";
    ...
    public String generarReactivoCloze(int numeroReactivo) {
        ...
        Integer respuestaA =4;
        Integer respuestaB = 3*(constanteA-constanteB);
        Integer respuestaC = -2*(constanteA*constanteB+constanteC);
        Integer respuestaD = (constanteB-constanteA)*constanteC;


        Integer respuestaE = 12;
        Integer respuestaF = 6*(constanteA-constanteB);
        Integer respuestaG = respuestaC;
...
//
    ...
    public static void main(String[] args) {
        EjecutadorGeneradorXML.generarReactivos(NOMBRE_ARCHIVO_SALIDA, NUMERO_DE_REACTIVOS, new GeneradorReactivo_Thomas_3_3ej38());
    }
